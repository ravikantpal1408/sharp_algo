...
public class Program
{
    ...
    {
        TrappingRainWater.MaxTrapperWater(new int[]{0,1, 0,2,1,0,3,1,0,1,2});
        // string original = "11211";
        // PallindromeChecker.CheckForPallindrome(original);
        // StringReversal.GetReversedString(original);
        ...
        // var str = "hello seatle this is the wonderland";
        // CharCounter.GetCharCounter(str);
